		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample app for odata_v4",
									"targetURL": "#Ui5Frontui5front-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Ui5Frontui5front-display": {
								"semanticObject": "Ui5Frontui5front",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Ui5Front.ui5front",
									"url": sap.ui.require.toUrl("Ui5Front/ui5front")
								}
							}
						}
					}
